                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                       
                                  <asp:BoundField HeaderText="Código" ItemStyle-HorizontalAlign="center"  SortExpression="CodigoComAno" 
                                        DataField="CodigoComAno" />             
                                    <asp:BoundField HeaderText="Cliente" ItemStyle-HorizontalAlign="left"  SortExpression="Cliente" 
                                        DataField="Cliente" />
                                  <%--  <asp:BoundField HeaderText="Equipamento" ItemStyle-HorizontalAlign="left"  SortExpression="Equipamento" 

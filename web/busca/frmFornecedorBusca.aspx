<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFornecedorBusca.aspx.cs" Inherits="frmFornecedorBusca" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                                   
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <a href="#" onclick='Selecionar(<%# ((Fornecedor)Container.DataItem).ID %>);' >Selecionar</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>  

...
public partial class frmFornecedorBusca : SortingPageBase
{
    ...
    {
        List<Fornecedor> list = Fornecedor.Select(txtTexto.Text, Convert.ToInt32(ddlTipoFornecedor.SelectedValue), "", "", DateTime.MinValue, DateTime.MinValue, Int32.MaxValue - 1, 0);
		this.Sort(list);

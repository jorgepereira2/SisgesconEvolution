<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLicitacaoDocumentoPesquisa.aspx.cs" Inherits="frmLicitacaoDocumentoPesquisa" %>
                        ...
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Número CI" ItemStyle-HorizontalAlign="center"  SortExpression="NumeroCI" 
                                        DataField="NumeroCI" />
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmLicitacaoDocumento.aspx?id_licitacao={0}" />    

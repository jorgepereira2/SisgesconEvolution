<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLicitacaoFinalizacaoPesquisa.aspx.cs" Inherits="frmLicitacaoFinalizacaoPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmLicitacaoFinalizacao.aspx?id_licitacao={0}" />    

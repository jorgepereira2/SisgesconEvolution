<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLicitacaoCancelamento.aspx.cs" Inherits="frmLicitacaoCancelamento" %>
...
<body>
    ...
    <uc:MotivoCancelamento runat="server" ID="ucMotivoCancelamento" TipoObjeto="Licitacao"  />
    <div align="center">
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="center">
                                     ...
                                     <asp:TemplateField HeaderText="Desativada" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# ((Licitacao)Container.DataItem).FlagDesativado ? "Sim" : "Não" %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" headertext="" >
                                        <ItemTemplate>
                                            <Anthem:LinkButton runat="server" ID="lnkDesativar" Text="Desativar" CommandName="Edit"
                                                Visible="<%# ((Licitacao)Container.DataItem).Status == StatusLicitacaoEnum.ContratoAssinado && !((Licitacao)Container.DataItem).FlagDesativado %>" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" headertext="" >
                                        <ItemTemplate>

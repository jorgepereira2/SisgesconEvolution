...
public partial class frmStatusLicitacaoResponsavel : MarinhaPageBase
{
    #region Private Mambers

    [TransientPageState]
    protected StatusLicitacao _status;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            _status = StatusLicitacao.Get(Convert.ToInt32(Request["id_status"]));

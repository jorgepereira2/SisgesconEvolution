<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLicitacaoDocumento.aspx.cs" Inherits="frmLicitacaoDocumento" %>
                ...
                <table border="0" cellpadding="2" cellspacing="4" width="100%" >
                    <tr>
                     ...
                     <tr>
                        ...
                        <td align="left">
                           <Anthem:Label runat="server" ID="lblNumeroCI" />                           
                        </td>
                    </tr>
                     <tr>
                        <td class="msgErro" >*</td>
                        ...
                        <td align="left">
                           <Anthem:Label runat="server" ID="lblObjetivo" />                           
                        </td>
                    </tr>
                    <tr>
                        <td class="msgErro" >*</td>
            ...
            <anthem:GridView runat="server" ID="gvDocumento" Width="100%" CssClass="datagrid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a href='<%# "frmLicitacaoDocumentoDownload.aspx?id=" + ((LicitacaoDocumento)Container.DataItem).ID %>' target="_blank">[Download]</a>
                        </ItemTemplate>                                          
                    </asp:TemplateField>                     
                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>

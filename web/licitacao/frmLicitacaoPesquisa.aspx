<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLicitacaoPesquisa.aspx.cs" Inherits="frmLicitacaoPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmLicitacaoCadastro.aspx?id_licitacao={0}" />   
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmLicitacaoCadastro.aspx?pedido=true&id_licitacao={0}" />   

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOMFPendente.aspx.cs" Inherits="frmOMFPendente" %>
...
<body>    
    ...
    <form id="form1" runat="server">
      ...
      <uc:InputBox runat="server" ID="ucInputBox"  />
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblID_Status" Text='<%# ((NotaEntregaMaterialOMF)Container.DataItem).Status.ID %>'  />                                            
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>                                       
                                    <asp:TemplateField HeaderText="Número" ItemStyle-HorizontalAlign="Center" SortExpression="NumeroNota">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Fornecedor" ItemStyle-HorizontalAlign="left" SortExpression="Fornecedor">
                                        <ItemTemplate>
                                            <%# ((NotaEntregaMaterialOMF)Container.DataItem).Fornecedor%>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>                                   
                                    ...
                                    <asp:TemplateField HeaderText="Data" ItemStyle-HorizontalAlign="center" SortExpression="DataEntrega">
                                        <ItemTemplate>

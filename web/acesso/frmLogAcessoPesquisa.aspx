<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLogAcessoPesquisa.aspx.cs" Inherits="frmLogAcessoPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Data" ItemStyle-HorizontalAlign="center"  SortExpression="Data" 
                                        DataField="Data" DataFormatString="{0:dd/MM/yyyy hh:mm}" HtmlEncode="false" />
                                    <asp:BoundField HeaderText="IP" ItemStyle-HorizontalAlign="center"  SortExpression="IP" 
                                        DataField="IP" />
                                    <asp:BoundField HeaderText="Navegador" ItemStyle-HorizontalAlign="center"  SortExpression="Browser" 
                                        DataField="Browser" />                                    

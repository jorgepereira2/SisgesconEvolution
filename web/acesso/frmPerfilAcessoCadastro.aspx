<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPerfilAcessoCadastro.aspx.cs" Inherits="frmPerfilAcessoCadastro" %>
...
<body>
    ...
    <br />
        ...
        <asp:Label runat="server" ID="lblPerfilAcesso"  />    
        &nbsp;
    ...
    <div align="left" style="width:90%">
     <ComponentArt:TabStrip id="TabStrip1" 
        ...
        <Tabs>
            <ComponentArt:TabStripTab Text="Perfil" PageViewId="pvPerfil" LookId="DefaultTabLook" runat="server" ID="tabPerfil" ClientSideCommand="parent.iframeresize();" />
        ...
        <ComponentArt:MultiPage id="MultiPage1" CssClass="MultiPage" runat="server" Width="100%">
              ...
              <ComponentArt:PageView CssClass="PageContent" id="pvPerfil" runat="server" width="100%">
                <br />
                 <table border="0" cellpadding="2" cellspacing="4" width="100%" >
                    ...
                    <tr>
                        ...
                        <td align="left">
                           ...
                           &nbsp;
                           <Anthem:RequiredFieldValidator runat="server" ID="valNome" ControlToValidate="txtnome" ValidationGroup="DadosBasicos"
                    ...
                    <tr>
                        ...
                        <td align="left">
                           <Anthem:CheckBox runat="server" ID="chkAtivo"  />
                        </td>
                    </tr>        
                 </table>  

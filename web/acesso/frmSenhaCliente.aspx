<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSenhaCliente.aspx.cs" Inherits="frmSenhaCliente" %>
...
<body>
    ...
    <br />
        Cadastro de Senhas de Clientes    
    </div>
            ...
            <td style="border:solid 1px black" valign="top">               
                ...
                <table border="0" cellpadding="2" cellspacing="4" width="100%" >
                    <tr>
                        ...
                        <td align="left">
                           <Anthem:DropDownList runat="server" ID="ddlCliente" AutoCallBack="true" />                           
                        </td>
                    </tr>
                     <tr>
                        <td width="10%" >&nbsp;</td>
                        ...
                        <td align="left">
                           <Anthem:Label runat="server" ID="lblLogin" />  
                        </td>
                    </tr>
                    <tr>
                        <td width="10%" >&nbsp;</td>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BaixaAC.ascx.cs" Inherits="BaixaAC" %>
<Anthem:Window runat="server" ID="winBaixaAC" style="left:100px;" Caption="Baixa de AC" OnClientShow="window.parent.expandiframe()" ScrollBars="Auto" 
...
<table border="0" cellpadding="2" cellspacing="4" width="100%" >
    <tr>
        ...
        <td align="left">
           <Anthem:LinkButton runat="server" ID="lnkNumeroAC" />           
        </td>
    </tr> 
    <tr>
        <td  ></td>
    ...
    <tr>
        ...
        <td align="left">
           <Anthem:Label runat="server" ID="lblNumeroEmpenho" />           
        </td>
    </tr> 
    <tr>
        <td  ></td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td align="left">
           <Anthem:TextBox runat="server" ID="txtOrdemBancaria" Columns="16" MaxLength="30"  />
           <Anthem:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Baixa" ErrorMessage="Campo obrigatório"
                ControlToValidate="txtOrdemBancaria" Display="Dynamic" />
        </td>
    </tr> 
     <tr>
        <td class="msgErro" ></td>
...
<Anthem:Button runat="server" ID="btnOk" CssClass="Button" Text="Ok" ValidationGroup="NotaEmpenho" EnabledDuringCallBack="false"

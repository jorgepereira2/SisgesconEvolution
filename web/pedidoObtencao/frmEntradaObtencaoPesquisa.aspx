<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmEntradaObtencaoPesquisa.aspx.cs" Inherits="frmEntradaObtencaoPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                                                      
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmEntradaObtencao.aspx?id_pedido={0}" />    

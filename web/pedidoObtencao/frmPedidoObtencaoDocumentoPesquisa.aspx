<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoObtencaoDocumentoPesquisa.aspx.cs" Inherits="frmPedidoObtencaoDocumentoPesquisa" %>
                                ...
                                <Columns>
                                   <asp:BoundField HeaderText="Número" ItemStyle-HorizontalAlign="center"  SortExpression="Numero" 
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmPedidoObtencaoDocumento.aspx?id_pedido={0}" />    

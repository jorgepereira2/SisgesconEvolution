<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMovimentoContaPesquisa.aspx.cs" Inherits="frmMovimentoContaPesquisa" %>
                        ...
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Conta" ItemStyle-HorizontalAlign="left"  SortExpression="Conta" DataField="Conta" />                                    
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmMovimentoContaCadastro.aspx?id_movimento={0}" />    

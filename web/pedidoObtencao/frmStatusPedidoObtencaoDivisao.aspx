<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStatusPedidoObtencaoDivisao.aspx.cs" Inherits="frmStatusPedidoObtencaoDivisao" %>
                        ...
                        <tr>                            
                            ...
                            <br />
                                ...
                                <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Divisão/Departamento" sortexpression="Celula">
                                            <ItemTemplate>
                                                <%# ((StatusPedidoObtencaoDivisao)Container.DataItem).Celula.Descricao %>
                                            </ItemTemplate>                                            
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="Servidor" sortexpression="Servidor">
                                            <ItemTemplate>
                                                <%# ((StatusPedidoObtencaoDivisao)Container.DataItem).Servidor%>
                                            </ItemTemplate>                                            
                                            <FooterTemplate>

...
public partial class frmStatusAutorizacaoCompraResponsavel : MarinhaPageBase
{
    #region Private Mambers

    [TransientPageState]
    protected StatusAutorizacaoCompra _status;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            _status = StatusAutorizacaoCompra.Get(Convert.ToInt32(Request["id_status"]));

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTransferenciaContacaoAC.aspx.cs" Inherits="frmTransferenciaContacaoAC" %>
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:DataGrid runat="server" ID="dgPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:TemplateColumn ItemStyle-HorizontalAlign="center" headertext="Número" >
                                        <ItemTemplate>
                                            <Anthem:Label runat="server" ID="lblTipo" Text='<%# ((ICompra)Container.DataItem).Tipo %>' Visible="false" />
                                            <%# ((ICompra)Container.DataItem).Tipo + " " + ((ICompra)Container.DataItem).Numero %>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>                                                                                                     
                                    <asp:TemplateColumn ItemStyle-HorizontalAlign="center" headertext="Comprador"  >
                                        <ItemTemplate>
                                            <%# ((ICompra)Container.DataItem).Servidor.NomeGuerra %>
                                        </ItemTemplate>
                                        <EditItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoCotacaoPesquisa.aspx.cs" Inherits="frmPedidoCotacaoPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Pedidos de Cotação
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Número" ItemStyle-HorizontalAlign="center"  SortExpression="Numero" 
                                        DataField="Numero" />                                                                
                                    <asp:BoundField HeaderText="Fornecedores" ItemStyle-HorizontalAlign="left"  SortExpression="DescricaoFornecedores" 
                                        DataField="DescricaoFornecedores" HtmlEncode="false" />                                                                
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmPedidoCotacaoCadastro.aspx?id_pedido={0}" />    

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmResponsavelEtapaPesquisa.aspx.cs" Inherits="frmResponsavelEtapaPesquisa" %>
...
<body>
    ...
    <table cellSpacing="4" cellPadding="3" border="0" Width="94%" >
        <tr>
            <td class="PageTitle">
        ...
        <tr>
            <td valign="top">                
                <table border="0" cellpadding="0" cellspacing="0" width="100%" >           
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvAC" Width="100%" CssClass="datagrid"
                                 AutoGenerateColumns="false" CellPadding="3" AllowSorting="true" >
                                <HeaderStyle CssClass="dgHeader" />                                    
                                <RowStyle CssClass="dgItem" />
                                <AlternatingRowStyle CssClass="dgAlternatingItem" />
                            ...
                            <Anthem:Panel runat="server" ID="Panel1" CssClass="msgErro" Visible=false>
                                <br />
                                Nenhum registro foi encontrado.
                            </Anthem:Panel>
                        </td>

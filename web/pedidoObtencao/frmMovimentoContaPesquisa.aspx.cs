...
public partial class frmMovimentoContaPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            Anthem.AnthemClientMethods.Redirect("frmMovimentoContaCadastro.aspx", btnNovo);
    ...
    {
        List<MovimentoConta> list = MovimentoConta.SelectMovimentoConta(txtNumeroDocumento.Text);
		this.Sort(list);

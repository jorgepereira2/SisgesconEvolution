<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoPOPesquisa.aspx.cs" Inherits="frmPedidoServicoPOPesquisa" %>
                        ...
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>  
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" headertext="" >
                                        <ItemTemplate>
                                            <Anthem:LinkButton runat="server" ID="lnkEditar" Text="Criar AC" />
                                        </ItemTemplate>
                                    </asp:TemplateField>                                                  
                                </Columns>
                            </anthem:gridview>

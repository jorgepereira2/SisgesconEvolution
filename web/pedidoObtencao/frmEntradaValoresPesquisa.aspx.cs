...
public partial class frmEntradaValoresPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmEntradaValoresCadastro.aspx", btnNovo);
    ...
    {
        List<EntradaValores> list = EntradaValores.SelectEntrada(txtNumeroDocumento.Text);
		this.Sort(list);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fchPedidoObtencaoCompleto.aspx.cs" Inherits="fchPedidoObtencaoCompleto" %>
...
<body>
    ...
    <table cellpadding="2" style="border:solid 1px black; width:98%">
        <tr>
            ...
            <td align="right" width="30%">
                 <b >
                 <asp:Label runat="server" ID="lblTitulo" Text="Pedido Obtenção" />
                 </b>
                <br />
                <br />
                <b>
    ...
    <div class="PageTitle" style="width:98%;text-align:right;">
        ...
        <table style="width:98%" cellpadding="2" cellspacing="3" class="TabelaRelatorio">
            ...
            <tr>
                <td align="left" valign="top"  colspan="2" >
                    <b>Outros Fornecedores Cotados:</b> <br>
                    <%# "Fornecedor 2: " + _pedido.FornecedorCotacao2 + (_pedido.FornecedorCotacao2 != null ? Shared.Common.Util.FormataCNPJ(_pedido.FornecedorCotacao2.CNPJ) : "") + "<br>" %>
                    <%# "Fornecedor 3: " + _pedido.FornecedorCotacao3 + (_pedido.FornecedorCotacao3 != null ? Shared.Common.Util.FormataCNPJ(_pedido.FornecedorCotacao3.CNPJ) : "") + "<br>" %>
                    <%# "Fornecedor 4: " + _pedido.FornecedorCotacao4 + (_pedido.FornecedorCotacao4 != null ? Shared.Common.Util.FormataCNPJ(_pedido.FornecedorCotacao4.CNPJ) : "") + "<br>" %>
                </td>
            </tr>
        </table>

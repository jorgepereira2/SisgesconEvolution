<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmEntradaObtencao.aspx.cs" Inherits="frmEntradaObtencao" %>
            ...
            <td style="border:solid 1px black" valign="top">                
                <table border="0" cellpadding="2" cellspacing="2" width="100%" >
                     <tr>
                        ...
                        <td align="left">
                           <Anthem:LinkButton runat="server" ID="lblPO"  />                           
                        </td>
                     </tr>
                     <tr>
                        <td width="5%" ></td>
                        ...
                        <td align="left">
                           <Anthem:LinkButton runat="server" ID="lblPS"  />                           
                        </td>
                    </tr>  
                     <tr>
                        <td ></td>
                                ...
                                <Columns>                                        
                                    ...
                                    <asp:TemplateColumn HeaderText="Qtd." ItemStyle-HorizontalAlign="center">
                                     ...
                                     <asp:TemplateColumn HeaderText="Qtd. Entregue" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# ((PedidoObtencaoItem)Container.DataItem).QuantidadeEntregue.ToString("N2") %>
                                        </ItemTemplate>                                       
                                    </asp:TemplateColumn>

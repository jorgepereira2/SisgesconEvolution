<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CancelarItem.ascx.cs" Inherits="CancelarItem" %>
...
<Anthem:Button runat="server" ID="btnOk" CssClass="Button" Text="Confirmar" ValidationGroup="Recusa" EnabledDuringCallBack="false"
    TextDuringCallBack="Aguarde" />&nbsp;
<Anthem:Button runat="server" ID="btnCancelar" CssClass="Button" Width="160px" Text="Sair sem cancelar" CausesValidation="false" />&nbsp;
</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoObtencaoEdicao.aspx.cs" Inherits="frmPedidoObtencaoEdicao" %>
...
<body>
    ...
    <br />
        Edição de Autorização de Compra
    </div>
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Número" ItemStyle-HorizontalAlign="center"  SortExpression="Numero" ReadOnly="true"
                                        DataField="Numero" />
                                    <asp:BoundField HeaderText="Status" ItemStyle-HorizontalAlign="center"  SortExpression="Status" ReadOnly="true"
                                        DataField="Status" />
                                     <asp:BoundField HeaderText="Célula" ItemStyle-HorizontalAlign="center"  SortExpression="Celula" ReadOnly="true"
                                        DataField="Celula" />
                                    <%--<asp:BoundField HeaderText="Aplicação" ItemStyle-HorizontalAlign="left"  SortExpression="Aplicacao" ReadOnly="true" 
                                        DataField="Aplicacao" />                                    --%>
                                    <asp:BoundField HeaderText="Data" ItemStyle-HorizontalAlign="center"  SortExpression="DataEmissao" ReadOnly="true" 
                                        DataField="DataEmissao" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" />

                                     <asp:TemplateField ItemStyle-HorizontalAlign="center" headertext="Responsavel" >
                                        <ItemTemplate>
                                            <%# ((PedidoObtencao)Container.DataItem).Servidor.NomeCompleto %>
                                        </ItemTemplate>
                                        <EditItemTemplate>

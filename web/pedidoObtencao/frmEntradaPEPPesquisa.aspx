<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmEntradaPEPPesquisa.aspx.cs" Inherits="frmEntradaPEPPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                                                      
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmEntradaPEP.aspx?id_pedido={0}" />    

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAutorizacaoCompraPesquisaEdicao.aspx.cs" Inherits="frmAutorizacaoCompraPesquisaEdicao" %>
<%@ Register Src="~/pedidoObtencao/EdicaoAC.ascx" TagName="EdicaoAC" TagPrefix="uc" %>
...
<body>
    ...
    <uc:EdicaoAC runat="server" ID="ucEdicaoAC" />
    <div align="center">
    <div align="right" style="width:90%" class="PageTitle">
    <br />
        Pesquisa de Autorização de Compra
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Valor Total" ItemStyle-HorizontalAlign="right"  SortExpression="ValorTotal" 
                                        DataField="ValorTotal" DataFormatString="{0:c2}" HtmlEncode="false" />                                    

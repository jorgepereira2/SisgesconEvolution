<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmEntradaACPesquisa.aspx.cs" Inherits="frmEntradaACPesquisa" %>
                        ...
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>       
                                    ...
                                    <asp:TemplateField HeaderText="AC" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <Anthem:LinkButton runat="server" ID="lnkAC" Text="<%# ((PedidoObtencao)Container.DataItem).CodigoComAno %>" />
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmEntradaAC.aspx?id_ac={0}" />    

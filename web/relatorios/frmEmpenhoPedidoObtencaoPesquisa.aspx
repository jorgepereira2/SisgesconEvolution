<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmEmpenhoPedidoObtencaoPesquisa.aspx.cs" Inherits="frmEmpenhoPedidoObtencaoPesquisa" %>
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlTipoPedido" /> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlDireto" >
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:TextBox runat="server" ID="txtNumeroPO" />
                                        </td>
                                    </tr>
                                </table>
                            </div>

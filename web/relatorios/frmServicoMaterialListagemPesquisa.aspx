<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmServicoMaterialListagemPesquisa.aspx.cs" Inherits="frmServicoMaterialListagemPesquisa" %>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlTipoRelatorio" >
                                                <Items>
                                                    <asp:ListItem Value="1">Listagem</asp:ListItem>
                                                    <asp:ListItem Value="2">Agrupado por Natureza Despesa</asp:ListItem>
                                                </Items>
                                            </Anthem:DropDownList>
                                        </td>
                                    </tr>    

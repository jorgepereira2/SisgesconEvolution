...
public partial class frmFaturamentoListagemPesquisa : MarinhaPageBase
{
    ...
    void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        list.Add("id_celula", ddlDepartamento.SelectedValue);
        ...
        string address = "frmFaturamentoListagem.aspx?" + Util.GetUrlParameterString(list);

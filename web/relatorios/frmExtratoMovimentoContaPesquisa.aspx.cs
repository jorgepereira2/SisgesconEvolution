...
public partial class frmExtratoMovimentoContaPesquisa : MarinhaPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            Util.FillDropDownList(ddlConta, Conta.List(), "Selecione uma Conta");
    ...
    void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        string address = "frmExtratoMovimentoConta.aspx?" + Util.GetUrlParameterString(list);

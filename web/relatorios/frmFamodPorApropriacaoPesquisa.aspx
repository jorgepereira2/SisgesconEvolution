<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFamodPorApropriacaoPesquisa.aspx.cs" Inherits="frmFamodPorApropriacaoPesquisa" %>
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataInicio" />
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDataInicio"
                                                 Display="Dynamic" ErrorMessage="Campo obrigatório" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataFim" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDataFim"

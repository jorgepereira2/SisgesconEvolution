...
public partial class frmPedidoServicoProntificacaoEquipamentoPesquisa : MarinhaPageBase
{
    ...
    void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        string address = "frmPedidoServicoProntificacaoEquipamento.aspx?" + Util.GetUrlParameterString(list);

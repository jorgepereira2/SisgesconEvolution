<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPosicaoEstoquePesquisa.aspx.cs" Inherits="frmPosicaoEstoquePesquisa" %>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <uc:BuscaMaterial runat="server" ID="ucBuscaMaterial" />
                                        </td>
                                    </tr>
                                     <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:CheckBox runat="server" ID="chkOcultarItensZerados" Checked="true" />
                                        </td>
                                    </tr>
                                     <tr>
                                        <td align="right">

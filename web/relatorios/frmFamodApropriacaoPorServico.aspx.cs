...
public partial class frmFamodApropriacaoPorServico : MarinhaPageBase
{
    private DataSet _ds;
	...
	protected void Bind()
    {
        ...
        dlFiltros.DataSource = (Dictionary<string, string>)Session["frmFamodApropriacaoPorServicoPesquisa.textoFiltros"];
	    dlFiltros.DataBind();
    }
    ...
    void dlCategoria_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            //int totalHorasDelineadas =Convert.ToInt32(

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoAquisicao.aspx.cs" Inherits="frmPedidoAquisicao" %>
...
<body>
    ...
    <div align="center">
   <uc:Cabecalho ID="Cabecalho1" runat="server" Titulo="Pedidos de Aquisição" />
    ...
    <Anthem:Panel runat="server" ID="pnGrid" >
      <WebControls:ReportGridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid" 
        ...
        <Columns>
            <asp:BoundField HeaderText="Numero" ItemStyle-HorizontalAlign="center"  SortExpression="Numero" 
                DataField="Numero" Visible="True" />
            ...
            <asp:BoundField HeaderText="Tipo" ItemStyle-HorizontalAlign="center"  SortExpression="TipoPedidoAquisicao" 
                DataField="TipoPedidoAquisicao" Visible="True" />            
            ...
            <asp:TemplateField HeaderText="Tipo Pagamento" SortExpression="TipoPagamento" Visible="false">
                <ItemTemplate>
                    <%# Shared.Common.Util.GetDescription(((PedidoAquisicao)Container.DataItem).TipoPagamento) %>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField HeaderText="Conta" ItemStyle-HorizontalAlign="center"  SortExpression="Conta" 
                DataField="Conta" Visible="false" /> 
            <asp:BoundField HeaderText="Meta" ItemStyle-HorizontalAlign="center"  SortExpression="Meta" 

      ...
      <WebControls:ReportGridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid" 
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="CNPJ" ItemStyle-HorizontalAlign="center"  SortExpression="CNPJ" 
              ...
              <asp:BoundField HeaderText="Número Contrato" ItemStyle-HorizontalAlign="center"  SortExpression="NumeroContrato" 
                DataField="NumeroContrato" Visible="True" />
            ...
            <asp:BoundField HeaderText="Data Cadastro" ItemStyle-HorizontalAlign="center" SortExpression="validadecertidaodividauniao" 
                DataField="DataCadastro" Visible="false" DataFormatString="{0:dd/MM/yyyy}" />

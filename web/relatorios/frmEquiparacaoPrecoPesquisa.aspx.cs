...
public partial class frmEquiparacaoPrecoPesquisa : MarinhaPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            Util.FillDropDownList(ddlDivisao, Celula.List(), "Todas");
    ...
    void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        string address = "frmEquiparacaoPreco.aspx?" + Util.GetUrlParameterString(list);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmServidorPermissaoPesquisa.aspx.cs" Inherits="frmServidorPermissaoPesquisa" %>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:TextBox runat="server" ID="txtNome" Columns="40" /> 
                                        </td>
                                    </tr>

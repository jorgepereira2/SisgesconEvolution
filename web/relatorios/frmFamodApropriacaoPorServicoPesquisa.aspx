<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFamodApropriacaoPorServicoPesquisa.aspx.cs" Inherits="frmFamodApropriacaoPorServicoPesquisa" %>
...
<body>
    ...
    <br />
        Relatório de Apropriação da Famod por Serviço
    </div>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <uc:BuscaCliente runat="server" ID="ucBuscaCliente" ShowNovo="false" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <uc:BuscaEquipamento runat="server" ID="ucBuscaEquipamento" ShowNew="false" />
                                        </td>
                                    </tr>
                                     <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            ...
                                            <Anthem:RequiredFieldValidator runat="server" ControlToValidate="txtDataInicio" ErrorMessage="Campo obrigatório"
                                                Display="Dynamic" />
                                            <Anthem:DateTextBox runat="server" ID="txtDataFim" />
                                            <Anthem:RequiredFieldValidator runat="server" ControlToValidate="txtDataFim" ErrorMessage="Campo obrigatório"
                                                Display="Dynamic" />
                                        </td>
                                    </tr>
                                </table>

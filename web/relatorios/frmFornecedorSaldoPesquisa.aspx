<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFornecedorSaldoPesquisa.aspx.cs" Inherits="frmFornecedorSaldoPesquisa" %>
...
<body>
    ...
    <br />
        Listagem de Saldos de Fornecedores
    </div>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">  
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlTipoCompra" /> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:TextBox runat="server" ID="txtMaterialFornecido" Columns="30" /> 
                                        </td>
                                    </tr>                                   
                                    <tr>
                                        <td align="right">

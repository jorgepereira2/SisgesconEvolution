<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoListagemPesquisa.aspx.cs" Inherits="frmPedidoServicoListagemPesquisa" %>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td align="right">
                                            Oficina Delineamento:
                                        </td>
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlOficinaDelineamento" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:TextBox runat="server" ID="txtCodigoPedidoCliente" />                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataPrevisaoEntregaInicio" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataPrevisaoEntregaFim" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataRealizadoInicio" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataRealizadoFim" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlStatusHistorico" /> 
                                        </td>
                                    </tr>  
                                     <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:CheckBox runat="server" ID="chkRecusado" /> 
                                        </td>
                                    </tr>  
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataHistoricoInicio" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataHistoricoFim" />
                                        </td>
                                    </tr>                     
                                </table>
                            </div>

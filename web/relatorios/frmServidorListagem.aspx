<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmServidorListagem.aspx.cs" Inherits="frmServidorListagem" %>
...
<body>
    ...
    <div align="center">
    <uc:Cabecalho ID="Cabecalho1" runat="server" Titulo="Listagem de Servidores" />
      ...
      <WebControls:ReportGridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid" 
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="E-mail" ItemStyle-HorizontalAlign="center"  SortExpression="Email" 
                DataField="Email" Visible="false" />
            <asp:BoundField HeaderText="Tipo" ItemStyle-HorizontalAlign="center"  SortExpression="TipoServidor" 
                DataField="TipoServidor" Visible="false" />
            <asp:TemplateField HeaderText="Faz Atv. Direta" ItemStyle-HorizontalAlign="center"  SortExpression="FlagFazAtividadeDireta"  Visible="false">
                <ItemTemplate>
                    <%# ((Servidor)Container.DataItem).FlagFazAtividadeDireta ? "Sim" : "Não" %>
                </ItemTemplate>
            </asp:TemplateField>

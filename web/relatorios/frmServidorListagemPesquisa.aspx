<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmServidorListagemPesquisa.aspx.cs" Inherits="frmServidorListagemPesquisa" %>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">    
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:TextBox runat="server" ID="txtGraduacao" Columns="30" /> 
                                        </td>
                                    </tr>
                                      <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlFazAtividadeDireta" >
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DropDownList runat="server" ID="ddlAtivo" >
                                                <asp:ListItem Value="0">Todos</asp:ListItem>
                                                <asp:ListItem Value="True">Sim</asp:ListItem>
                                                <asp:ListItem Value="False">Não</asp:ListItem>
                                            </Anthem:DropDownList>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoStatusPorCelula.aspx.cs" Inherits="frmPedidoServicoStatusPorCelula" %>
...
<body>
    ...
    <div align="center">
    <uc:Cabecalho ID="Cabecalho1" runat="server" Titulo="Status de Pedidos de Serviço por Célula" />    
    <div>
    <br />

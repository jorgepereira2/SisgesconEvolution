...
public partial class frmFamodPorApropriacaoPesquisa : MarinhaPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            Util.FillDropDownList(ddlApropriacao, Apropriacao.List(), "Todas");
    ...
    void btnImprimir_Click(object sender, EventArgs e)
    {
        ...
        list.Add("id_apropriacao", ddlApropriacao.SelectedValue);
        ...
        string address = "frmFamodPorApropriacao.aspx?" + Util.GetUrlParameterString(list);

...
public partial class frmStatusPedidoAquisicaoDivisao : MarinhaPageBase
{
    #region Private Mambers

    [TransientPageState]
    protected StatusPedidoAquisicao _status;
    ...
    void ucMessageBox_MessageBoxClose(object sender, MessageBoxEventArgs e)
    {
        if(e.Result == MessageBoxResult.Sim)
        {
            ...
            StatusPedidoAquisicaoDivisao divisao = _status.ResponsaveisDivisao.Find(Convert.ToInt32(e.Data));
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            _status = StatusPedidoAquisicao.Get(Convert.ToInt32(Request["id_status"]));
    ...
    void dgCadastro_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "Insert")
        {
            try
            {
                ...
                StatusPedidoAquisicaoDivisao responsavelDivisao = new StatusPedidoAquisicaoDivisao();
                ...
                responsavelDivisao.StatusPedidoAquisicao = _status;
    ...
    void dgCadastro_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        if(e.Item.ItemType == ListItemType.Footer)
        {
            ...
            if (Convert.ToInt32(Request["id_status"]) == Convert.ToInt32(StatusPedidoAquisicaoEnum.AguardandoAprovacaoEncarregadoDivisao))

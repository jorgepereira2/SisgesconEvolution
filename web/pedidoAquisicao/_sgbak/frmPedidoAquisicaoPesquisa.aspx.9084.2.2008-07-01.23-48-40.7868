<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoAquisicaoPesquisa.aspx.cs" Inherits="frmPedidoAquisicaoPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Pedidos de Aquisição
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmPedidoAquisicaoCadastro.aspx?id_pedido={0}" />    

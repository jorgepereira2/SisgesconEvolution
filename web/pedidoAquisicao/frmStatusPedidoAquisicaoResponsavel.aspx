<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStatusPedidoAquisicaoResponsavel.aspx.cs" Inherits="frmStatusPedidoAquisicaoResponsavel" %>
...
<body>
    ...
    <br />
        <asp:label ID="Label1" runat="server" CssClass="PageTitle" Text="Responsáveis por Etapa">
            </asp:label>
                                ...
                                <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>                                        
                                        <asp:TemplateColumn HeaderText="Servidor" sortexpression="Servidor">
                                            <ItemTemplate>
                                                <%# ((Servidor)Container.DataItem).Identificacao %>
                                            </ItemTemplate>                                            
                                            <FooterTemplate>

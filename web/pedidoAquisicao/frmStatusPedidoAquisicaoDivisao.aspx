<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStatusPedidoAquisicaoDivisao.aspx.cs" Inherits="frmStatusPedidoAquisicaoDivisao" %>
                                ...
                                <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Divisão" sortexpression="Celula">
                                            <ItemTemplate>
                                                <%# ((StatusPedidoAquisicaoDivisao)Container.DataItem).Celula.Descricao %>
                                            </ItemTemplate>                                            
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="Servidor" sortexpression="Servidor">
                                            <ItemTemplate>
                                                <%# ((StatusPedidoAquisicaoDivisao)Container.DataItem).Servidor%>
                                            </ItemTemplate>                                            
                                            <FooterTemplate>

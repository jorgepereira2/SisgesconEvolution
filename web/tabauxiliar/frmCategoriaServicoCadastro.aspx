<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmCategoriaServicoCadastro.aspx.cs" Inherits="frmCategoriaServicoCadastro" %>
                            ...
                            <br />
                                ...
                                <br />
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Identificador" sortexpression="Identificador">
                                            <ItemTemplate>
                                                <%# ((CategoriaServico)Container.DataItem).Identificador %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtIdentificador" columns="4" MaxLength="2" 
                                                    Text=' <%# ((CategoriaServico)Container.DataItem).Identificador %>' />
                                                <Anthem:RequiredFieldValidator runat="server" ControlToValidate="txtIdentificador" 
                                                     Display="Dynamic" ValidationGroup="Descricao" ErrorMessage="Campo Obrigatório" /> 
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:TextBox runat="server" ID="txtIdentificador" columns="40" MaxLength="2" />
                                                <Anthem:RequiredFieldValidator runat="server" ControlToValidate="txtIdentificador" 
                                                     Display="Dynamic" ValidationGroup="Descricao" ErrorMessage="Campo Obrigatório" /> 
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((CategoriaServico)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((CategoriaServico)Container.DataItem).Descricao %>' />
                                        ...
                                        <asp:TemplateColumn HeaderText="Requer Faturamento" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((CategoriaServico)Container.DataItem).FlagRequerFaturamento ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkRequerFaturamento" Text="Sim" checked='<%# ((CategoriaServico)Container.DataItem).FlagRequerFaturamento %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkRequerFaturamento" Text="Sim" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                         <asp:TemplateColumn HeaderText="Mergulho" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((CategoriaServico)Container.DataItem).FlagMergulho ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkMergulho" Text="Sim" checked='<%# ((CategoriaServico)Container.DataItem).FlagMergulho %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkMergulho" Text="Sim" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((CategoriaServico)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((CategoriaServico)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((CategoriaServico)Container.DataItem).ID %>)' >

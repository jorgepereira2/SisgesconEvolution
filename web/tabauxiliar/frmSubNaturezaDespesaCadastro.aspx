<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSubNaturezaDespesaCadastro.aspx.cs" Inherits="frmSubNaturezaDespesaCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Sub-Item Natureza Despesa
                        ...
                        <tr>                            
                            ...
                            <br />
                                <div align="left" style="vertical-align:text-bottom" class="PageTitle">
                                    Sub-Item de Natureza de Despesa
                                 ...
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((SubNaturezaDespesa)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((SubNaturezaDespesa)Container.DataItem).Descricao %>' />
                                        ...
                                        <asp:TemplateColumn HeaderText="Tipo Equipamento" sortexpression="NaturezaDespesa">
                                            <ItemTemplate>
                                                <%# ((SubNaturezaDespesa)Container.DataItem).NaturezaDespesa.Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:DropDownList  runat="server" ID="ddlNaturezaDespesa" />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:DropDownList  runat="server" ID="ddlNaturezaDespesaNovo" />
                                            </FooterTemplate>
                                        </asp:TemplateColumn>                                    
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((SubNaturezaDespesa)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((SubNaturezaDespesa)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivoNovo" Text="Ativo" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                         <asp:TemplateColumn HeaderText="Industrial" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((SubNaturezaDespesa)Container.DataItem).Industrial ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkIndustrial" Text="Industrial" checked='<%# ((SubNaturezaDespesa)Container.DataItem).Industrial %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkIndustrial" Text="Industrial" />                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((SubNaturezaDespesa)Container.DataItem).ID %>)' >

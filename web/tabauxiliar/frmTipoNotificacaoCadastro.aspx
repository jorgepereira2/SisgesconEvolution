<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTipoNotificacaoCadastro.aspx.cs" Inherits="frmTipoNotificacaoCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Tipo de Notificação
                                 ...
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((TipoNotificacao)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((TipoNotificacao)Container.DataItem).Descricao %>' />
                                        ...
                                        <asp:TemplateColumn HeaderText="Aprovação" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((TipoNotificacao)Container.DataItem).FlagAprovacao ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkFlagAprovacao" Text="Aprovação" checked='<%# ((TipoNotificacao)Container.DataItem).FlagAprovacao %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkFlagAprovacao" Text="Aprovação" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>                                                                     
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((TipoNotificacao)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((TipoNotificacao)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((TipoNotificacao)Container.DataItem).ID %>)' >

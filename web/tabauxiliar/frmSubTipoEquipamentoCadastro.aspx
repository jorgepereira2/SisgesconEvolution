<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSubTipoEquipamentoCadastro.aspx.cs" Inherits="frmSubTipoEquipamentoCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Sub-Tipo de Equipamento
                                 ...
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((SubTipoEquipamento)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((SubTipoEquipamento)Container.DataItem).Descricao %>' />
                                        ...
                                        <asp:TemplateColumn HeaderText="Tipo Equipamento" sortexpression="TipoEquipamento">
                                            <ItemTemplate>
                                                <%# ((SubTipoEquipamento)Container.DataItem).TipoEquipamento.Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:DropDownList  runat="server" ID="ddlTipoEquipamento" />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:DropDownList  runat="server" ID="ddlTipoEquipamentoNovo" />
                                            </FooterTemplate>
                                        </asp:TemplateColumn>                                    
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((SubTipoEquipamento)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((SubTipoEquipamento)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((SubTipoEquipamento)Container.DataItem).ID %>)' >

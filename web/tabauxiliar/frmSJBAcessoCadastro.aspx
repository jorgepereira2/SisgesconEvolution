<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSJBAcessoCadastro.aspx.cs" Inherits="frmSJBAcessoCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Acesso ap Símbolo de Juristição Brasileira
                        ...
                        <tr>                            
                            ...
                            <br />
                                <div align="left" style="vertical-align:text-bottom" class="PageTitle">
                                    Símbolos de Juristição Brasileira
                                 ...
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Código" sortexpression="Codigo">
                                            <ItemTemplate>
                                                <%# ((SJB)Container.DataItem).Codigo %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtCodigo" columns="4" MaxLength="2" 
                                                    Text=' <%# ((SJB)Container.DataItem).Codigo %>' />
                                            ...
                                            <FooterTemplate>
                                                <Anthem:TextBox runat="server" ID="txtCodigoNovo" columns="40" MaxLength="2" />
                                        ...
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((SJB)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((SJB)Container.DataItem).Descricao %>' />
                                        ...
                                        <asp:TemplateColumn HeaderText="Acesso Restrito" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((SJB)Container.DataItem).FlagAcessoRestrito ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAcessoRestrito" Text="Acesso Restrito" checked='<%# ((SJB)Container.DataItem).FlagAcessoRestrito %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAcessoRestrito" Text="Acesso Restrito" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((SJB)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((SJB)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((SJB)Container.DataItem).ID %>)' >

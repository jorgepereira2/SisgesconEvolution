<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTipoAtividadeSecundariaCadastro.aspx.cs" Inherits="frmTipoAtividadeSecundariaCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Tipo de Atividades Secundárias
                                 ...
                                 <Anthem:DataGrid runat="server" ID="dgCadastro" Width="98%" CssClass="datagrid"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Descrição" sortexpression="Descricao">
                                            <ItemTemplate>
                                                <%# ((TipoAtividadeSecundaria)Container.DataItem).Descricao %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:TextBox  runat="server" ID="txtDescricao" columns="40" Text=' <%# ((TipoAtividadeSecundaria)Container.DataItem).Descricao %>' />
                                         ...
                                         <asp:TemplateColumn HeaderText="Sem Taxas" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((TipoAtividadeSecundaria)Container.DataItem).SemTaxas ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkSemTaxas" Text="Sem Taxas" checked='<%# ((TipoAtividadeSecundaria)Container.DataItem).SemTaxas %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkSemTaxasNovo" Text="Sem Taxas" Checked="true"/>                                                
                                            </FooterTemplate>
                                        </asp:TemplateColumn>                                  
                                         <asp:TemplateColumn HeaderText="Ativo" ItemStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <%# ((TipoAtividadeSecundaria)Container.DataItem).FlagAtivo ? "Sim" : "Nao" %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <Anthem:CheckBox runat="server" ID="chkAtivo" Text="Ativo" checked='<%# ((TipoAtividadeSecundaria)Container.DataItem).FlagAtivo %>' />                                                
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="#" onclick='javascript:Excluir(<%# ((TipoAtividadeSecundaria)Container.DataItem).ID %>)' >

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoMergulhoDetalhamento.aspx.cs" Inherits="frmPedidoServicoMergulhoDetalhamento" %>
<%@ Import Namespace="Marinha.Business" %>
<%@ Register Src="~/UserControls/BuscaServicoMaterial.ascx" TagPrefix="uc" TagName="ServicoMaterial" %>
<%@ Register Src="DadosComplementaresItemServico.ascx" TagPrefix="uc" TagName="DadosComplementares" %>
...
<body>
    ...
    <br />
        Detalhamento de Pedido de Serviço de Mergulho    
    </div>
                ...
                <table border="0" cellpadding="2" cellspacing="2" width="100%" >
                  ...
                  <%-- <tr>
                     ...
                     <tr>
                        ...
                        <td align="left">
                           <Anthem:DateTextBox runat="server" ID="txtDataPrevisaoInicio" />                            
                        </td>
                    </tr>  
                      <tr>
                        <td ></td>
                        ...
                        <br />
                            ...
                            <Anthem:DataGrid runat="server" ID="dgDelineamento" Width="98%" CssClass="datagrid"
                                ...
                                <Columns>                                         
                                    ...
                                    <asp:TemplateColumn HeaderText="Tempo Faina Diaria" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).TempoFainaDiaria %>
                                        </ItemTemplate>                                        
                                        <FooterTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtTempoFainaDiariaNovo" columns="8" MaxLength="8" DecimalPlaces="0"/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="txtTempoFainaDiariaNovo" 
                                                 Display="Dynamic" ValidationGroup="Delineamento" ErrorMessage="Campo Obrigatório" /> 
                                        </FooterTemplate>
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtTempoFainaDiaria" columns="8" MaxLength="8" DecimalPlaces="0"
                                             Text='<%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).TempoFainaDiaria %>'
                                            />                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="txtTempoFainaDiaria" 
                                                 Display="Dynamic" ValidationGroup="DelineamentoEdit" ErrorMessage="Campo Obrigatório"/> 
                                        </EditItemTemplate>
                                    </asp:TemplateColumn> 

                                      <asp:TemplateColumn HeaderText="Número Dias" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).NumeroDias %>
                                        </ItemTemplate>                                        
                                        <FooterTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtNumeroDiasNovo" columns="8" MaxLength="8" DecimalPlaces="0"/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="txtNumeroDiasNovo" 
                                                 Display="Dynamic" ValidationGroup="Delineamento" ErrorMessage="Campo Obrigatório" /> 
                                        </FooterTemplate>
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtNumeroDias" columns="8" MaxLength="8" DecimalPlaces="0"
                                             Text='<%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).NumeroDias %>'
                                            />                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="txtNumeroDias" 
                                                 Display="Dynamic" ValidationGroup="DelineamentoEdit" ErrorMessage="Campo Obrigatório"/> 
                                        </EditItemTemplate>
                                    </asp:TemplateColumn> 
                                      ...
                                      <asp:TemplateColumn HeaderText="Qtd. Mergulhadores" ItemStyle-HorizontalAlign="center">
                                        ...
                                        <FooterTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtQuantidadeMergulhadoresNovo" columns="8" MaxLength="8" DecimalPlaces="0"/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="txtQuantidadeMergulhadoresNovo" 
                                                 Display="Dynamic" ValidationGroup="Delineamento" ErrorMessage="Campo Obrigatório" /> 
                                        </FooterTemplate>
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtQuantidadeMergulhadores" columns="8" MaxLength="8" DecimalPlaces="0"
                                             Text='<%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).QuantidadeMergulhadores %>'
                                            />                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtQuantidadeMergulhadores" 
                                                 Display="Dynamic" ValidationGroup="DelineamentoEdit" ErrorMessage="Campo Obrigatório"/> 
                                        </EditItemTemplate>
                                    </asp:TemplateColumn> 
                                    ...
                                    <asp:TemplateColumn HeaderText="Descrição Serviço" ItemStyle-HorizontalAlign="left">
                                        ...
                                        <EditItemTemplate>
                                            <Anthem:TextBox  runat="server" ID="txtDescricaoServico" columns="20" MaxLength="14" TextMode="MultiLine"
                                                Rows="2"  Text='<%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).DescricaoServicoOficina %>'/>                                            
                                        </EditItemTemplate>
                                    </asp:TemplateColumn>                                                                                                           
                                    <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            &nbsp;
                                             <a href="#" onclick='javascript:ExcluirDelineamento(<%# ((PedidoServicoMergulhoDelineamento)Container.DataItem).ID %>)' >
                                                    Excluir
                                                </a>
                                        </ItemTemplate>
                                        <FooterTemplate>
                            ...
                            <Anthem:DataGrid runat="server" ID="dgMaterial" Width="98%" CssClass="datagrid"
                                ...
                                <Columns>                                             
                                     <asp:TemplateColumn HeaderText="Código Material" ItemStyle-HorizontalAlign="left" >
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ServicoMaterial.CodigoInterno %>
                                        </ItemTemplate>                                       
                                        <FooterTemplate>
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            Material:<br />
                                            <Anthem:TextBox runat="server" ID="txtCodigoMaterial" AutoCallBack="true" OnTextChanged="txtCodigoMaterial_TextChanged" 
                                                Text='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ServicoMaterial.CodigoInterno %>'  />                                            
                                            <br />
                                            <uc:ServicoMaterial runat="server" ID="ucServicoMaterial" AutoCallBack="true" OnSelectedValueChanged="ucServicoMaterial_SelectedValueChanged"  
                                                SelectedValue='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ServicoMaterial.ID %>'
                                                TipoServicoMaterial="Material" 
                                                Text='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ServicoMaterial.Descricao %>'  />                                                
                                            <br />                                           
                                            Origem:<br />
                                    ...
                                    <asp:TemplateColumn HeaderText="Oficina" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                             <%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).Celula.Descricao %>                                          
                                        </ItemTemplate>                                     
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="Qtd." ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).Quantidade + " " + ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ServicoMaterial.Unidade.Descricao %>
                                        </ItemTemplate>                                        
                                        <FooterTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtQuantidadeNovo" columns="5" MaxLength="8" DecimalPlaces="2"/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txtQuantidadeNovo" 
                                        ...
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtQuantidade" columns="5" MaxLength="8" DecimalPlaces="2"
                                                text='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).Quantidade %>'/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="txtQuantidade" 
                                      ...
                                      <FooterTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtValor" columns="8" MaxLength="14" 
                                                CssClass="numerico" DecimalPlaces="2" Text='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).Valor.ToString("N2") %>'/>                                                
                                    ...
                                    <asp:TemplateColumn HeaderText="" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <Anthem:LinkButton runat="server" ID="btnEditar" Text="Editar" 
                                                    CommandName="Edit" CausesValidation="false" />
                                            &nbsp;
                                             <a href="#" onclick='javascript:Excluir(<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).ID %>)' >
                                                    Excluir
                                                </a>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                ...
                                <Columns>                                             
                                    ...
                                    <asp:TemplateColumn HeaderText="Qtd." ItemStyle-HorizontalAlign="center">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="txtQuantidadeNovo" 
                                        ...
                                        <EditItemTemplate>
                                            <Anthem:NumericTextBox  runat="server" ID="txtQuantidade" columns="5" MaxLength="8" DecimalPlaces="0"
                                                text='<%# ((PedidoServicoMergulhoItemOrcamento)Container.DataItem).Quantidade %>'/>                                                
                                            <Anthem:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="txtQuantidade" 
                                                 Display="Dynamic" ValidationGroup="Servico" ErrorMessage="Campo Obrigatório" /> 
                                        </EditItemTemplate>
                                    </asp:TemplateColumn> 
                                   <asp:TemplateColumn HeaderText="Valor" ItemStyle-HorizontalAlign="right">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoMergulhoPendente.aspx.cs" Inherits="frmPedidoServicoMergulhoPendente" %>
                ...
                <table border="0" cellpadding="2" cellspacing="0" width="100%" >
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="98%" CssClass="datagrid"
                                ...
                                <Columns>                                            
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" Visible="false" >
                                        <ItemTemplate>
                                            <Anthem:Label runat="server" ID="lblID_Status" Text='<%# ((PedidoServicoMergulho)Container.DataItem).Status.ID %>' />
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>    
                                    <asp:TemplateField HeaderText="Código Interno" ItemStyle-HorizontalAlign="Center" SortExpression="CodigoInterno">
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulho)Container.DataItem).CodigoComAno%>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>  
                                     <asp:TemplateField HeaderText="Faturamento" ItemStyle-HorizontalAlign="Center" >
                                        <ItemTemplate>
                                            <a runat="server" ID="lnkFaturamento" class="detalhe" >Imprimir</a>
                                            <br/>
                                            <Anthem:LinkButton runat="server" ID="btnRecalcular" Text="Recalcular Fatura" CommandName="Recalcular" CommandArgument=" <%# ((PedidoServicoMergulho)Container.DataItem).ID %>"
                                               CausesValidation="false"  />
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>                    
                                    <asp:TemplateField HeaderText="Cliente" ItemStyle-HorizontalAlign="left" SortExpression="DescricaoCliente" >
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulho)Container.DataItem).DescricaoCliente%>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>                                   
                                    <asp:TemplateField HeaderText="Situação" ItemStyle-HorizontalAlign="center" SortExpression="DescricaoStatus" >
                                        <ItemTemplate>
                                            <%# ((PedidoServicoMergulho)Container.DataItem).DescricaoStatus%>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>

...
public partial class frmStatusPedidoServicoDivisao : MarinhaPageBase
{
    ...
    void ucMessageBox_MessageBoxClose(object sender, MessageBoxEventArgs e)
    {
        if(e.Result == MessageBoxResult.Sim)
        {
            ...
            StatusPedidoServicoMergulhoDivisao divisao = _status.ResponsaveisDivisao.Find(Convert.ToInt32(e.Data));
    ...
    void dgCadastro_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "Insert")
        {
            try
            {
                ...
                StatusPedidoServicoMergulhoDivisao responsavelDivisao = new StatusPedidoServicoMergulhoDivisao();
                ...
                responsavelDivisao.StatusPedidoServicoMergulho = _status;

...
public partial class BuscaPedidoServico : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AnthemClientMethods.Popup(btnBuscaAvancada, "../busca/frmPedidoServicoBusca.aspx?id_controle=" + this.ClientID, false, false, false, true, true, true,
    ...
    public delegate void SelectedValueChangedHandler(object source, BuscaPedidoServicoEventArgs e);
    ...
    void txtPedidoServico_TextChanged(object source, Anthem.AutoSuggestEventArgs e)
    {
        try
        {
            txtPedidoServico.DataSource = PedidoServico.FastSearch(e.CurrentText);
    ...
    public void FireEvent(string id)
    {
        ...
        if (id != "" && id != "0")
            ps = PedidoServico.Get(Convert.ToInt32(id));
        ...
        if (SelectedValueChanged != null)
            SelectedValueChanged(this, new BuscaPedidoServicoEventArgs(ps));
    }
	
}

public class BuscaPedidoServicoEventArgs : EventArgs
{
    private readonly PedidoServico _pedidoServico;

    public BuscaPedidoServicoEventArgs(PedidoServico _pedido)
    {
        this._pedidoServico = _pedido;
    }

    public PedidoServico PedidoServico
    {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoOrcamentoConfirma.aspx.cs" Inherits="frmPedidoServicoOrcamento" %>
                            ...
                            <Anthem:DataGrid runat="server" ID="dgMaterial" Width="98%" CssClass="datagrid"
                                ...
                                <Columns>         
                                     ...
                                     <asp:TemplateColumn HeaderText="Código Material" ItemStyle-HorizontalAlign="left" >
                                        ...
                                        <%--<FooterTemplate>
                                            <div style="text-align:left">
                                                Material:<br /> 
                                                <div runat="server" ID="txt_1"><%# ((PedidoServicoItemOrcamento)Container.DataItem).ServicoMaterial.CodigoInterno %></div>                                                                                    
                                                <br />   
                                                <div runat="server" ID="Ditxt_2v1"><%# ((PedidoServicoItemOrcamento)Container.DataItem).ServicoMaterial.Descricao %></div>                                                                                    
                                                Origem:<br />
                                    ...
                                    <asp:TemplateColumn HeaderText="Serviço/Material" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <%# ((PedidoServicoItemOrcamento)Container.DataItem).ServicoMaterial.Descricao %><br>
                                            Origem Material: <%# ((PedidoServicoItemOrcamento)Container.DataItem).ServicoMaterial.OrigemMaterial %>
                                        </ItemTemplate>                                       
                                        <%--<FooterTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Dados Complementares" ItemStyle-HorizontalAlign="Center">
                                         <ItemTemplate>

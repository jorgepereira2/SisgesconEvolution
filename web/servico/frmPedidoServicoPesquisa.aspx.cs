...
public partial class frmPedidoServicoPesquisa : SortingPageBase
{
    ...
    void gvPesquisa_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string address = "frmPedidoServicoCadastro.aspx?id_pedido=" + pedido.ID.ToString();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            Anthem.AnthemClientMethods.Redirect("frmPedidoServicoCadastro.aspx", btnNovo);
    ...
    protected override void Bind()
    {
        ...
        List<PedidoServico> list = PedidoServico.Select(
                ...
                Convert.ToInt32(StatusPedidoServicoEnum.NaoEnviado),
                Int32.MinValue,
                Int32.MinValue,
                "",
                "",
    ...
    private void BtnEnviar_OnClick(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridViewRow in gvPesquisa.Rows)
        {
            if (gridViewRow.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    count++;
                    PedidoServico ps = PedidoServico.Get(Convert.ToInt32(gvPesquisa.DataKeys[gridViewRow.RowIndex][0]));

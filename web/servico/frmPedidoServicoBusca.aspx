<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoBusca.aspx.cs" Inherits="frmPedidoServicoBusca" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {            
            opener.document.getElementById('id_pedidoServico').value = id;
            
            setTimeout('opener.PedidoSelecionado();', 100);
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <uc:BuscaEquipamento runat="server" ID="ucBuscaEquipamento" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                       
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <a href="#" onclick='Selecionar(<%# ((PedidoServico)Container.DataItem).ID %>);' >Selecionar</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>  

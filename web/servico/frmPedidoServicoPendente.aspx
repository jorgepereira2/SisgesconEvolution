<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoPendente.aspx.cs" Inherits="frmPedidoServicoPendente" %>
<%@ Register Src="~/UserControls/MessageBox.ascx" TagName="MessageBox" TagPrefix="uc" %>
<%@ Register Src="RecusarEtapa.ascx" TagName="RecusarEtapa" TagPrefix="uc" %>
<%@ Register Src="DesignarCotador.ascx" TagName="DesignarCotador" TagPrefix="uc" %>
<%@ Register Src="MensagemCliente.ascx" TagName="MensagemCliente" TagPrefix="uc" %>
<%@ Register Src="AguardandoIndicacaoRecurso.ascx" TagName="AguardandoIndicacaoRecurso" TagPrefix="uc" %>
<%@ Register Src="AguardandoInicioExecucao.ascx" TagName="AguardandoInicioExecucao" TagPrefix="uc" %>
<%@ Register Src="EmExecucao.ascx" TagName="EmExecucao" TagPrefix="uc" %>
...
<body>
    ...
    <uc:MensagemCliente runat="server" ID="ucMensagemCliente"  />
    <uc:AguardandoIndicacaoRecurso runat="server" ID="ucAguardandoIndicacaoRecurso"  />
    <uc:AguardandoInicioExecucao runat="server" ID="ucAguardandoInicioExecucao"  />
    <uc:EmExecucao runat="server" ID="ucEmExecucao"  />
    
    <%--<uc:RegistrarDevolucaoMeio runat="server" ID="ucDevolucaoMeio"  />--%>    
    <uc:InsereFaturamento runat="server" ID="ucInsereFaturamento"  />
    <uc:DesignarCotador runat="server" ID="ucDesignarCotador"  />
    <div align="center">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            Status:&nbsp;<Anthem:DropDownList runat="server" ID="ddlStatus" />
                               ...
                               &nbsp;&nbsp;&nbsp;
                            Gerente:&nbsp;<Anthem:DropDownList runat="server" ID="ddlGerente" />
                        </td>
                    </tr>   
                    <tr>
                        <td align="left">   
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                                            
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" Visible="false" >
                                        <ItemTemplate>
                                            <Anthem:Label runat="server" ID="lblID_Status" Text='<%# ((IPedido)Container.DataItem).Status.ID %>' />
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>    
                                    <asp:TemplateField HeaderText="Código Interno" ItemStyle-HorizontalAlign="Center" SortExpression="CodigoInterno">
                                     ...
                                     <asp:TemplateField HeaderText="PS Cliente" ItemStyle-HorizontalAlign="Center" SortExpression="CodigoPedidoCliente">
                                        <ItemTemplate>
                                            <%# ((IPedido)Container.DataItem).CodigoPedidoCliente %>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>                    
                                    <asp:TemplateField HeaderText="Cliente" ItemStyle-HorizontalAlign="left" SortExpression="DescricaoCliente" >
                                        <ItemTemplate>
                                            <%# ((IPedido)Container.DataItem).DescricaoCliente %>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Equipamento" ItemStyle-HorizontalAlign="left" SortExpression="DescricaoEquipamentos" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Situação" ItemStyle-HorizontalAlign="center" SortExpression="DescricaoStatus" >
                                        <ItemTemplate>
                                            <%# ((IPedido)Container.DataItem).DescricaoStatus %>
                                        </ItemTemplate>                                          
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                           ...
                                           <Anthem:LinkButton runat="server" Visible="False" ID="btnRegistrarOcorrencia" Text="Registrar Ocorrência" CommandName="RegistrarOcorrencia" 
                                               CausesValidation="false" CommandArgument="<%# ((IPedido)Container.DataItem).ID %>" />
                                        </ItemTemplate>                                          
                                    </asp:TemplateField> 
                                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RecusarAprovacao.ascx.cs" Inherits="RecusarAprovacao" %>
<Anthem:Window runat="server" ID="winRecusa" style="left:120px;" Caption="Recusar Pedido de Serviço" OnClientShow="window.parent.expandiframe()" ScrollBars="Auto" 

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoCancelamento.aspx.cs" Inherits="frmPedidoServicoCancelamento" %>
<%@ Register Src="~/servico/MotivoCancelamento.ascx" TagName="MotivoCancelamento" TagPrefix="uc" %>
<%@ Register Src="~/servico/Reativar.ascx" TagName="Reativar" TagPrefix="uc" %>
...
<body>
    ...
    <script type="text/javascript" src="../js/wz_tooltip.js" ></script>
     <uc:MotivoCancelamento runat="server" ID="ucMotivoCancelamento" TipoObjeto="PedidoServico"  />
    <uc:Reativar runat="server" ID="ucReativar"  />
    <div align="center">
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                       
                                    ...
                                    <asp:BoundField HeaderText="Cliente" ItemStyle-HorizontalAlign="left"  SortExpression="Cliente" 
                                        DataField="Cliente" />
                                    <asp:BoundField HeaderText="Equipamento" ItemStyle-HorizontalAlign="left"  SortExpression="DescricaoEquipamentos" 
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="center" headertext="" >
                                        <ItemTemplate>
                                            <Anthem:LinkButton runat="server" ID="lnkAtivar" Text="Reativar" CommandName="Edit" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </anthem:gridview>

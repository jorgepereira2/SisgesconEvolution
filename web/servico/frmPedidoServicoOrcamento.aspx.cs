    ...
    void dgDelineamento_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "Insert")
        {
            try
            {
                ...
                foreach (DelineamentoOficina delineamentoOficina in _delineamentoOrcamento.Delineamentos)
                {
                    if (delineamentoOficina.Servidor.ID == this.ID_Servidor)
                        servidor = delineamentoOficina.Servidor;
                }
                ...
                delineamento.ServidorDelineamento = servidor;

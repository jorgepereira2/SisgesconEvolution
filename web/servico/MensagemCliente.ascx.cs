...
public partial class MensagemCliente : System.Web.UI.UserControl
{
    ...
    public void Show(bool mensagemCliente)
    {
        if(mensagemCliente)
        {
            lblLabel.Text = "Informe o número da mensagem";
            winMensagem.Caption = "Número Mensagem Cliente";
        }
        else
        {
            lblLabel.Text = "Informe o número NL";
            winMensagem.Caption = "Liquidação";
        }
        winMensagem.Show();
    }

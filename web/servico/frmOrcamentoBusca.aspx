<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOrcamentoBusca.aspx.cs" Inherits="frmOrcamentoBusca" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {            
            opener.document.getElementById('id_orcamento').value = id;
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>                       
                                    ...
                                    <asp:BoundField HeaderText="Cliente" ItemStyle-HorizontalAlign="left"  SortExpression="Cliente" 
                                        DataField="Cliente" />
                                    <asp:BoundField HeaderText="Equipamento" ItemStyle-HorizontalAlign="left"  DataField="DescricaoEquipamentoa" />    
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <a href="#" onclick='Selecionar(<%# ((DelineamentoOrcamento)Container.DataItem).ID %>);' >Selecionar</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>  

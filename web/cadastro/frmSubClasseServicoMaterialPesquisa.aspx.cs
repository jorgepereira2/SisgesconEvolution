...
public partial class frmSubClasseServicoMaterialPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmSubClasseServicoMaterialCadastro.aspx", btnNovo);
    ...
    {
        List<SubClasseServicoMaterial> list = SubClasseServicoMaterial.Select(Convert.ToInt32(ddlClasseServicoMaterial.SelectedValue),
        txtTexto.Text);
		this.Sort(list);

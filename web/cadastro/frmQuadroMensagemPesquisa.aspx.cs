...
public partial class frmQuadroMensagemPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmQuadroMensagemCadastro.aspx", btnNovo);
        }
    }
    #endregion  
    ...
    {
		List<QuadroMensagem> list = QuadroMensagem.Select(txtTexto.Text);
		this.Sort(list);

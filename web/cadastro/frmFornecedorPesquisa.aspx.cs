...
public partial class frmFornecedorPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmFornecedorCadastro.aspx", btnNovo);
    ...
    {
		List<Fornecedor> list = Fornecedor.Select(txtTexto.Text, Convert.ToInt32(ddlTipoFornecedor.SelectedValue), "", "", DateTime.MinValue, DateTime.MinValue,

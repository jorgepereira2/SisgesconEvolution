...
public partial class frmServidorPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmServidorCadastro.aspx", btnNovo);
    ...
    {
		List<Servidor> list = Servidor.Select(txtNome.Text, Convert.ToInt32(ddlDivisao.SelectedValue));
		this.Sort(list);

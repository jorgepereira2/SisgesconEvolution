<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmServidorDetalhePesquisa.aspx.cs" Inherits="frmServidorDetalhePesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmServidorDetalheCadastro.aspx?id_servidor={0}" />    

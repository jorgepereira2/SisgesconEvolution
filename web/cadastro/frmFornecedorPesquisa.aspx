<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFornecedorPesquisa.aspx.cs" Inherits="frmFornecedorPesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid" PageSize="20" 
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmFornecedorCadastro.aspx?id_fornecedor={0}" />                                       
                                </Columns>
                            </anthem:gridview>

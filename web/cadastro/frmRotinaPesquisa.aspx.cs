...
public partial class frmRotinaPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmRotinaCadastro.aspx", btnNovo);
        }
    }
    #endregion  
    ...
    {
		List<Rotina> list = Rotina.Select(txtTexto.Text);
		this.Sort(list);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmRotinaPesquisa.aspx.cs" Inherits="frmRotinaPesquisa" %>
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Código" ItemStyle-HorizontalAlign="center"  SortExpression="ID" 
                                        DataField="ID" />
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmRotinaCadastro.aspx?id_Rotina={0}" />    

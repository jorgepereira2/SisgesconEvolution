<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmClasseServicoMaterialPesquisa.aspx.cs" Inherits="frmClasseServicoMaterialPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Classe de Serviço/Material
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmClasseServicoMaterialCadastro.aspx?id_classe={0}" />    

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFaturaPagamentoMensalPesquisa.aspx.cs" Inherits="frmFaturaPagamentoMensalPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Faturas de Pagamento
    </div>
                            ...
                            <div align="left" style="vertical-align:text-bottom">                                
                                ...
                                <table width="100%" cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataEmissaoInicio" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataEmissaoFim" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <Anthem:DateTextBox runat="server" ID="txtDataVencimentoInicio" />&nbsp;a&nbsp;
                                            <Anthem:DateTextBox runat="server" ID="txtDataVencimentoFim" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>  
                                    <asp:BoundField HeaderText="Número Fatura" ItemStyle-HorizontalAlign="center"  SortExpression="NumeroFaturaOS" 
                                        DataField="NumeroFaturaOS" />             
                                    <asp:BoundField HeaderText="Servidor/Fornecedor" ItemStyle-HorizontalAlign="left"  SortExpression="NomeDestinatario" 
                                        DataField="NomeDestinatario" />
                                    <asp:BoundField HeaderText="Emissão" ItemStyle-HorizontalAlign="center"  SortExpression="DataEmissao" 
                                        DataField="DataEmissao" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" /> 
                                    <asp:BoundField HeaderText="Vencimento" ItemStyle-HorizontalAlign="center"  SortExpression="DataVencimento" 
                                        DataField="DataVencimento" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" /> 

...
public partial class frmServicoMaterialCadastro : MarinhaPageBase
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        this.dgCelula.DeleteCommand +=new DataGridCommandEventHandler(dgCelula_DeleteCommand);
        
        ddlClasseServicoMaterial.SelectedIndexChanged += delegate { ClasseServicoMaterialChanged(); };
        ddlNaturezaDespesa.SelectedIndexChanged += delegate { NaturezaDespesaChanged(); };
    }

    private void NaturezaDespesaChanged()
    {
        if (ddlNaturezaDespesa.SelectedValue != "0")
        {
            Util.FillDropDownList(ddlSubNaturezaDespesa, SubNaturezaDespesa.List(Convert.ToInt32(ddlNaturezaDespesa.SelectedValue)), ESCOLHA_OPCAO);
    ...
    private void FillPage()
    {
        ...
        Util.FillDropDownList(ddlNaturezaDespesa, NaturezaDespesa.ListAll(), ESCOLHA_OPCAO);
        Util.FillDropDownList(ddlCelula, Celula.List(), ESCOLHA_OPCAO);
        Util.InsertDefaultItem(ddlSubNaturezaDespesa, ESCOLHA_OPCAO);
    }
    ...
    void btnSalvar_Click(object sender, EventArgs e)
    {
        if (TabStrip1.SelectedTab.ID == tabDadosBasicos.ID)
            ...
            SalvarLocalizacao();
        else if (TabStrip1.SelectedTab.ID == tabCelula.ID)
            SalvarCelula();
    }
    ...
    {
        if (ServicoMaterial.GetDuplicado(
            _servicomaterial.Descricao,
            _servicomaterial.NumeroSerie,
            _servicomaterial.TipoServicoMaterial
        ).Count > 0)
        {
            DialogResult dr = MessageBox.Show("Os dados do produto cadastrado já existe, deseja continuar?", "Confirmação de cadastro", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Information);
    ...
    private void PopulateFields()
    {
        ...
        ddlClasseServicoMaterial.SelectedValue = _servicomaterial.SubClasseServicoMaterial.ClasseServicoMaterial.ID.ToString();
        ...
        ddlNaturezaDespesa.SelectedValue = ObjectReader.ReadID(_servicomaterial.NaturezaDespesa);
        ...
        txtNumeroSerie.Text = _servicomaterial.NumeroSerie;
        ...
        txtQuantidadeMinimaPEP.Text = ObjectReader.ReadInt(_servicomaterial.QuantidadeMinimaPEP);
        //txtQuantidadeMinimaRodizio.Text = ObjectReader.ReadInt(_servicomaterial.QuantidadeMinimaRodizio);
        txtQuantidadeMaximaPEP.Text = ObjectReader.ReadInt(_servicomaterial.QuantidadeMaximaPEP);
        //txtQuantidadeMinimaSingra.Text = ObjectReader.ReadInt(_servicomaterial.QuantidadeMinimaSingra);
        //txtQuantidadeMaximaRodizio.Text = ObjectReader.ReadInt(_servicomaterial.QuantidadeMaximaRodizio);
        txtPrecoEstimadoVenda.Text = ObjectReader.ReadDecimal(_servicomaterial.PrecoEstimadoVenda);
        //txtQuantidadeMaximaSingra.Text = ObjectReader.ReadDecimal(_servicomaterial.QuantidadeMaximaSingra);

        NaturezaDespesaChanged();

        ddlSubNaturezaDespesa.SelectedValue = _servicomaterial.SubNaturezaDespesa != null ? _servicomaterial.SubNaturezaDespesa.ID.ToString() : "0"; //ObjectReader.ReadID(_servicomaterial.SubNaturezaDespesa);
    ...
    private void ClearFields()
    {
        ...
        txtQuantidadeMinimaPEP.Text = "0";
        //txtQuantidadeMinimaRodizio.Text = "0";
        txtQuantidadeMaximaPEP.Text = "0";
        //txtQuantidadeMinimaSingra.Text = "0";
        //txtQuantidadeMaximaSingra.Text = "0";
        //txtQuantidadeMaximaRodizio.Text = "0";
        txtPrecoEstimadoVenda.Text = "0";
        ...
        txtNumeroSerie.UpdateAfterCallBack = true;
        ...
        txtQuantidadeMinimaPEP.UpdateAfterCallBack = true;
        //txtQuantidadeMinimaRodizio.UpdateAfterCallBack = true;
        txtQuantidadeMaximaPEP.UpdateAfterCallBack = true;
        //txtQuantidadeMinimaSingra.UpdateAfterCallBack = true;
        //txtQuantidadeMaximaSingra.UpdateAfterCallBack = true;
        //txtQuantidadeMaximaRodizio.UpdateAfterCallBack = true;
        txtPrecoEstimadoVenda.UpdateAfterCallBack = true;
    }
    ...
    private void FillObject()
    {
        ...
        _servicomaterial.NaturezaDespesa = NaturezaDespesa.Get(Convert.ToInt32(ddlNaturezaDespesa.SelectedValue));
        _servicomaterial.SubNaturezaDespesa = SubNaturezaDespesa.Get(Convert.ToInt32(ddlSubNaturezaDespesa.SelectedValue));
        ...
        _servicomaterial.NumeroSerie = PageReader.ReadString(txtNumeroSerie);
        ...
        _servicomaterial.QuantidadeMinimaPEP = PageReader.ReadInt(txtQuantidadeMinimaPEP);
        //_servicomaterial.QuantidadeMinimaRodizio = PageReader.ReadInt(txtQuantidadeMinimaRodizio);
        _servicomaterial.QuantidadeMaximaPEP = PageReader.ReadInt(txtQuantidadeMaximaPEP);
        //_servicomaterial.QuantidadeMinimaSingra = PageReader.ReadInt(txtQuantidadeMinimaSingra);
        //_servicomaterial.QuantidadeMaximaRodizio = PageReader.ReadInt(txtQuantidadeMaximaRodizio);
        _servicomaterial.PrecoEstimadoVenda = PageReader.ReadDecimal(txtPrecoEstimadoVenda);
    }
    ...
    #region Celula
    private void BindCelula()
    {
        dgCelula.DataSource = _servicomaterial.Celulas;
        dgCelula.DataKeyField = "ID";
        dgCelula.DataBind();
        dgCelula.UpdateAfterCallBack = true;
        Anthem.AnthemClientMethods.ResizeIFrame();
    }

    void dgCelula_DeleteCommand(object source, DataGridCommandEventArgs e)
    {
        int id = Convert.ToInt32(dgCelula.DataKeys[e.Item.ItemIndex]);
        _servicomaterial.RemoveCelula(id);
        BindCelula();
    }

    private void ClearFieldsCelula()
    {
        ddlCelula.SelectedIndex = -1;
        RefreshFieldsCelula();
    }

    private void RefreshFieldsCelula()
    {
        ddlCelula.UpdateAfterCallBack = true;
    }

    private void SalvarCelula()
    {
        if (this.IsValid)
        {
            _servicomaterial.AddCelula(Convert.ToInt32(ddlCelula.SelectedValue));
            BindCelula();
            ClearFieldsCelula();
            RefreshFieldsCelula();
        }
    ...
    public void AbaAlterada()
    {
        if (TabStrip1.SelectedTab.ID == tabDadosBasicos.ID)
            ...
            btnSalvar.ValidationGroup = "Celula";

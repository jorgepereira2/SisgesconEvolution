...
public partial class frmClientePesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmClienteCadastro.aspx", btnNovo);
    ...
    {
		List<Cliente> list = Cliente.Select(txtTexto.Text, Convert.ToInt32(ddlTipoCliente.SelectedValue));
		this.Sort(list);

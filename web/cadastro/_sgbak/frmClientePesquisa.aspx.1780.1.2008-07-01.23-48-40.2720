<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmClientePesquisa.aspx.cs" Inherits="frmClientePesquisa" %>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmClienteCadastro.aspx?id_cliente={0}" />    

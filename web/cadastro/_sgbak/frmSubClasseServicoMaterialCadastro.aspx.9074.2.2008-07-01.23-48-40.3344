<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSubClasseServicoMaterialCadastro.aspx.cs" Inherits="frmSubClasseServicoMaterialCadastro" %>
...
<body>
    ...
    <br />
        Cadastro de Sub-Classe de Serviço/Material
            ...
            <td style="border:solid 1px black" valign="top">
                ...
                <table border="0" cellpadding="2" cellspacing="4" width="100%" >
                     ...
                     <tr>
						...
						<td align="left">
							<Anthem:DropDownList runat="server" ID="ddlClasseServicoMaterial" AutoCallBack="true" />	
							   &nbsp;
							   <Anthem:RequiredFieldValidator runat="server" ControlToValidate="ddlClasseServicoMaterial"
					...
					<tr>
                        ...
                        <td align="left">
                           <Anthem:TextBox runat="server" ID="txtEspecificacao" Columns="50" TextMode="MultiLine" Rows="3" />

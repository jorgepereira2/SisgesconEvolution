<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQuadroMensagemPesquisa.aspx.cs" Inherits="frmQuadroMensagemPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Quadro de Mensagens
    </div>
                    ...
                    <tr>
                        <td valign="top" align="center">
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Título" ItemStyle-HorizontalAlign="left"  SortExpression="Titulo" 
                                        DataField="Titulo" />
                                    <asp:BoundField HeaderText="Data Início" ItemStyle-HorizontalAlign="center"  SortExpression="DataInicio" 
                                        DataField="DataInicio" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" />
                                    <asp:BoundField HeaderText="Data Fim" ItemStyle-HorizontalAlign="center"  SortExpression="DataFim" 
                                        DataField="DataFim" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="false" />
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmQuadroMensagemCadastro.aspx?id_quadromensagem={0}" />    

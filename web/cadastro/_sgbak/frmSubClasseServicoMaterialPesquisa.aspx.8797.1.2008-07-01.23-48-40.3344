<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmSubClasseServicoMaterialPesquisa.aspx.cs" Inherits="frmSubClasseServicoMaterialPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Sub-Classe de Serviço/Material
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmSubClasseServicoMaterialCadastro.aspx?id_subclasse={0}" />    

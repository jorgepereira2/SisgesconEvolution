...
public partial class frmClasseServicoMaterialPesquisa : SortingPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
			...
			Anthem.AnthemClientMethods.Redirect("frmClasseServicoMaterialCadastro.aspx", btnNovo);
    ...
    {
        List<ClasseServicoMaterial> list = ClasseServicoMaterial.Select(txtTexto.Text);
		this.Sort(list);

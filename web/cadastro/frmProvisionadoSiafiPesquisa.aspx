<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmProvisionadoSiafiPesquisa.aspx.cs" Inherits="frmProvisionadoSiafiPesquisa" %>
...
<body>
    ...
    <br />
        Pesquisa de Provisionado Siafi
    </div>
                             ...
                             <anthem:GridView runat="server" ID="gvPesquisa" Width="100%" CssClass="datagrid" PageSize="20" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ano" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%# ((ProvisionadoSiafi)Container.DataItem).Ano %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Código" ItemStyle-HorizontalAlign="Center" SortExpression="CodigoSiafi">
                                        <ItemTemplate>
                                            <%# ((ProvisionadoSiafi)Container.DataItem).CodigoSiafi %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Ação Interna" SortExpression="Projeto">
                                        <ItemTemplate>
                                            <%# ((ProvisionadoSiafi)Container.DataItem).Projeto.Descricao %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="NaturezaDespesa" SortExpression="NaturezaDespesa">
                                        <ItemTemplate>
                                            <%# ((ProvisionadoSiafi)Container.DataItem).NaturezaDespesa.Descricao %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:HyperLinkField NavigateUrl="" Text="Editar" itemstyle-horizontalalign="center"
                                         DataNavigateUrlFields="ID" DataNavigateUrlFormatString="frmProvisionadoSiafiCadastro.aspx?id_ProvisionadoSiafi={0}" />                                       
                                </Columns>
                            </anthem:gridview>

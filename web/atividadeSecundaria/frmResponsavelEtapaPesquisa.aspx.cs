...
public partial class frmResponsavelEtapaPesquisa : SortingPageBase
{
    ...
    {
        List<StatusPedidoServicoAtividadeSecundaria> list = StatusPedidoServicoAtividadeSecundaria.Select();
		this.Sort(list);
    ...
    void gvPesquisa_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if(e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            StatusPedidoServicoAtividadeSecundaria status = (StatusPedidoServicoAtividadeSecundaria)e.Row.DataItem;
            string address = "";

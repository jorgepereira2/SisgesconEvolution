<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPedidoServicoAtividadeSecundariaCancelamento.aspx.cs" Inherits="frmPedidoServicoAtividadeSecundariaCancelamento" %>
...
<body>
    ...
    <script type="text/javascript" src="../js/wz_tooltip.js" ></script>
     <uc:MotivoCancelamento runat="server" ID="ucMotivoCancelamento" TipoObjeto="PedidoServicoAtividadeSecundaria"  />
    <div align="center">
    <div align="right" style="width:90%" class="PageTitle">
    <br />
        Cancelamento de PSAS
    </div>

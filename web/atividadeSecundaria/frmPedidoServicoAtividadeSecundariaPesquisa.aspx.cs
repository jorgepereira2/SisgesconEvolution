...
public partial class frmPedidoServicoAtividadeSecundariaPesquisa : SortingPageBase
{
    ...
    void gvPesquisa_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string address = "frmPedidoServicoAtividadeSecundariaCadastro.aspx?id_pedido=" + pedido.ID.ToString();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            Anthem.AnthemClientMethods.Redirect("frmPedidoServicoAtividadeSecundariaCadastro.aspx", btnNovo);
    ...
    protected override void Bind()
    {
        ...
        List<PedidoServicoAtividadeSecundaria> list = PedidoServicoAtividadeSecundaria.Select(
                ...
                Convert.ToInt32(StatusPedidoServicoAtividadeSecundariaEnum.NaoEnviado),
                Int32.MinValue);

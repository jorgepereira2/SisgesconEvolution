...
{
	[Serializable]
	public partial class TipoPedidoAquisicao : BusinessObject<TipoPedidoAquisicao>, IComparable<TipoPedidoAquisicao>
	{
	    ...
	    public virtual TipoPedidoAquisicaoEnum Enum
	    {
	        get{ return (TipoPedidoAquisicaoEnum) ID;}
	    }
		#endregion 
		...
		public static Dictionary<int, string> List()
		{
			...
			from TipoPedidoAquisicao t  			
			order by t.Descricao");
		
			return BusinessHelper.ExecuteList(query); 
		}
		
		public static List<TipoPedidoAquisicao> Select()
		{
			ISession session = NHibernateSessionManager.Instance.GetSession();
			IQuery query = session.CreateQuery(
			@"from TipoPedidoAquisicao t  			
			...
			return (List<TipoPedidoAquisicao>)query.List<TipoPedidoAquisicao>();
		}
		
		#endregion

        public virtual int CompareTo(TipoPedidoAquisicao other)
	    {

...
{
	[Serializable]
	public partial class TipoFornecedor : BusinessObject<TipoFornecedor>, IDescricao, IComparable<TipoFornecedor>
	{
		...
		public static List<TipoFornecedor> Select()
		{
			ISession session = NHibernateSessionManager.Instance.GetSession();
			IQuery query = session.CreateQuery(
			@"from TipoFornecedor t  			
			...
			return (List<TipoFornecedor>)query.List<TipoFornecedor>();
		}
		
		#endregion

        public virtual int CompareTo(TipoFornecedor other)
	    {

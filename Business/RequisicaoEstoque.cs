        ...
        public virtual void Finalizar()
        {
            ...
            using (TransactionBlock tran = new TransactionBlock())
            {
                foreach (RequisicaoEstoqueItem item in _itens)
                {
                    ...
                    movimento.OrigemMaterial = item.OrigemMaterial == OrigemMaterial.Obtencao ? OrigemMaterial.PEP : item.OrigemMaterial;
                    movimento.Save();
                    ...
                    if (this.TipoRequisicaoEstoque.TipoRequisicaoEstoqueEnum == TipoRequisicaoEstoqueEnum.Transferencia)
                    {
                        ...
                        movimentoEntrada.OrigemMaterial = item.OrigemMaterialDestino.Value == OrigemMaterial.Obtencao ? OrigemMaterial.PEP : item.OrigemMaterialDestino.Value;

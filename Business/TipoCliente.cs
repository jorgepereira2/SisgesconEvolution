...
{
	[Serializable]
    public partial class TipoCliente : BusinessObject<TipoCliente>, IDescricao, IComparable<TipoCliente>	
	{
		...
		public static List<TipoCliente> Select()
		{
			ISession session = NHibernateSessionManager.Instance.GetSession();
			IQuery query = session.CreateQuery(
			@"from TipoCliente t  			
			...
			return (List<TipoCliente>)query.List<TipoCliente>();
		}
		
		#endregion

        public virtual int CompareTo(TipoCliente other)
	    {

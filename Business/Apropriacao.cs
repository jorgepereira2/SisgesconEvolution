...
{
	[Serializable]
    public partial class Apropriacao : BusinessObject<Apropriacao>, IDescricao, IComparable<Apropriacao>	
	{
		...
		public static List<Apropriacao> Select()
		{
			ISession session = NHibernateSessionManager.Instance.GetSession();
			IQuery query = session.CreateQuery(
			@"from Apropriacao a  			
			...
			return (List<Apropriacao>)query.List<Apropriacao>();
		}
		
		#endregion

	    public virtual int CompareTo(Apropriacao other)
	    {
